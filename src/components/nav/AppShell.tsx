...
export function AppShell({ children, notice }: { children: ReactNode; notice: ReactNode }) {
  ...
  return <div className={`app-shell${sidebarCollapsed ? " app-shell--collapsed" : ""}${standalone ? " app-shell--standalone" : ""}${recording ? " app-shell--recording" : ""}`}>
    <a className="skip-link" href="#main-content">Skip to content</a>
    {!standalone && <NavBar collapsed={sidebarCollapsed} onToggle={() => setSidebarCollapsed(value => !value)} />}
