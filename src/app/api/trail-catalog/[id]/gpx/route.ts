...
export async function GET(_request: Request, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    return new Response(catalogGpx(detail.trail, detail.lines), { headers: { "Content-Type": "application/gpx+xml; charset=utf-8", "Content-Disposition": 'attachment; filename="trailpack-section.gpx"', "Cache-Control": "public, max-age=3600" } });
